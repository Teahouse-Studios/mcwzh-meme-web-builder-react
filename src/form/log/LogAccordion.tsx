              ...
              {log.log.split('\n').map((line, index) => {
                return (
                  <Typography
                    ...
                    color={
                      {
                        warning: 'warning.' + theme.palette.mode,
                        error: 'error.' + theme.palette.mode,
                        success: 'success.' + theme.palette.mode,
                        info: 'info.' + theme.palette.mode,
